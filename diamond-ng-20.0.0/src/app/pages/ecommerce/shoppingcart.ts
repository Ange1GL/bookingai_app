        ...
        <div class="card">
            ...
            <ul class="list-none p-0 m-0">
                <li class="flex flex-col md:flex-row py-12 border-t border-b border-surface-200 dark:border-surface-700 md:items-center">
                    <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/shoppingcart/shopping-cart-2-1.png" class="w-48 shrink-0 mx-auto md:mx-0" alt="shopping-cart-2-1" />
                ...
                <li class="flex flex-col md:flex-row py-12 border-t border-b border-surface-200 dark:border-surface-700 md:items-center">
                    <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/shoppingcart/shopping-cart-2-2.png" class="w-48 shrink-0 mx-auto md:mx-0" alt="shopping-cart-2-2" />
                    <div class="flex-auto py-8 md:pl-8">
                        <div class="flex flex-wrap items-start sm:items-center sm:flex-row sm:justify-between border-surface-200 dark:border-surface-700 pb-12">
                            <div class="w-full sm:w-6/12 flex flex-col">
                                <span class="text-surface-900 dark:text-surface-0 text-xl font-medium mb-4">Product Name</span>
            ...
            <div class="flex">
                ...
                <ul class="list-none py-0 pr-0 pl-0 md:pl-8 mt-12 mx-0 mb-0 flex-auto">
                    ...
                    <li class="flex justify-between border-t border-surface-200 dark:border-surface-700 mb-6 pt-6">
                        <span class=" text-surface-900 dark:text-surface-0 font-bold text-3xl">Total</span>
                        <span class=" text-surface-900 dark:text-surface-0 font-bold text-3xl">$90.00</span>
                    </li>
...
export class ShoppingCart {
    ...
    selectedQuantity1: number = 1;

    selectedQuantity2: number = 1;
}
