        ...
        <p-dialog [(visible)]="productDialog" [style]="{ width: '450px' }" header="Product Details" [modal]="true">
            <ng-template #content>
                <div class="flex flex-col gap-6">
                    @if (product.image) {
                        <img [src]="'/demo/images/product/' + product.image" [alt]="product.image" class="block m-auto pb-6" />
                    }
                    <div>
                    ...
                    <div>
                        <span class="block font-bold mb-6">Category</span>
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-6">
                            <label for="price" class="block font-bold mb-4">Price</label>
                            <p-inputnumber id="price" [(ngModel)]="product.price" mode="currency" currency="USD" locale="en-US" fluid />
                        </div>
                        <div class="col-span-6">
                            <label for="quantity" class="block font-bold mb-4">Quantity</label>
