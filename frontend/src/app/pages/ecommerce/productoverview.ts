            ...
            <div class="grid grid-cols-12 gap-4 mb-16">
                ...
                <div class="col-span-12 lg:col-span-4 py-4 lg:pl-12">
                    ...
                    <div class="flex items-center mb-8">
                        ...
                        ></div>
                        <div
                            class="w-8 h-8 shrink-0 rounded-full bg-green-500 mr-4 cursor-pointer border-2 border-surface-200 dark:border-surface-700 transition-all duration-300"
                            [style.box-shadow]="color === 'green' ? '0 0 0 0.2rem var(--p-green-500)' : null"
                            (click)="color = 'green'"
                        ></div>
                        <div
                            class="w-8 h-8 shrink-0 rounded-full bg-blue-500 cursor-pointer border-2 border-surface-200 dark:border-surface-700 transition-all duration-300"
                    ...
                    <div class="flex flex-wrap gap-4 items-center mb-8">
                        <div
                            class="h-12 w-12 border border-surface-300 dark:border-surface-500 text-surface-900 dark:text-surface-0 inline-flex justify-center items-center shrink-0 rounded cursor-pointer hover:bg-surface-100 dark:hover:bg-surface-700 duration-150 transition-colors"
                            [ngClass]="{
                    ...
                    <div class="flex flex-col sm:flex-row items-start sm:items-center flex-wrap gap-4">
                        ...
                        <div class="flex items-center flex-0 lg:flex-1 gap-4">
                            <button pButton pRipple label="Add to Cart" class="shrink-0 w-full"></button>
                            <i
