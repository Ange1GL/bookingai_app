    ...
    template: `
            ...
            <div class="flex flex-wrap mt-8 pb-4">
                <div class="w-full lg:w-6/12 pl-4">
                    ...
                    <div class="flex items-center mt-4">
                        <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/ordersummary/visa.png" class="w-16 mr-4" alt="visa" />
                        <div class="flex flex-col">
        ...
        <div class="card">
            ...
            <div class="flex flex-col md:flex-row md:items-center border-b border-surface-200 dark:border-surface-700 py-8">
                <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/ordersummary/order-summary-2-1.png" class="w-60 shrink-0 md:mr-12" />
            ...
            <div class="py-8 flex justify-between flex-wrap">
                ...
                <div class="flex flex-col">
                    ...
                    <div class="flex items-center mt-4">
                        <img src="https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/ordersummary/visa.png" class="w-16 mr-4" alt="visa-2" />
                        <div class="flex flex-col">
                            <span class="text-surface-900 dark:text-surface-0 mb-1">Visa Debit Card</span>
                            <span class="text-surface-900 dark:text-surface-0 font-medium">**** **** **** 1234</span>
                        </div>
    ...
    products = [
        {
            ...
            price: '$12',
            quantity: '1',
            image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/ordersummary/order-summary-1-1.png'
        },
        {
            name: 'Regular Jeans',
            size: 'Large',
            ...
            price: '$24',
            quantity: '1',
            image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/ordersummary/order-summary-1-2.png'
        }
    ];
}
