...
@Component({
    ...
    imports: [DividerModule, IconFieldModule, InputIconModule],
    template: `
        <div class="card">
                ...
                <div class="bg-surface-0 dark:bg-surface-900 grid grid-cols-12 gap-4 grid-nogutter rounded shadow mb-12">
                    ...
                    <div class="col-span-12">
                        @for (product of order.products; track product; let i = $index) {
                            <div class="p-2 my-6 flex flex-col lg:flex-row justify-between items-center">
                                ...
                                @if (i !== order.products.length - 1) {
                                    <p-divider class="w-full block! lg:hidden! border-surface-200 dark:border-surface-700"></p-divider>
                                }
                            </div>
                        }
                    </div>
            ...
            products: [
                {
                    ...
                    image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/orderhistory/orderhistory-1-1.png'
                },
                {
                    name: 'Product Name Placeholder A Little Bit Long One',
                    color: 'White',
                    ...
                    price: '$50',
                    deliveryDate: 'Delivered on 7 February 2023',
                    image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/orderhistory/orderhistory-1-2.png'
                },
                {
                    name: 'Product Name Placeholder A Little Bit Long One',
                    color: 'White',
                    ...
                    price: '$63',
                    deliveryDate: 'Delivered on 7 February 2023',
                    image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/orderhistory/orderhistory-1-3.png'
                }
            ]
        },
        {
            ...
            products: [
                {
                    ...
                    image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/orderhistory/orderhistory-1-4.png'
                },
                {
                    name: 'Product Name Placeholder A Little Bit Long One',
                    color: 'White',
                    ...
                    price: '$20',
                    deliveryDate: 'Delivered on 9 February 2023',
                    image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/orderhistory/orderhistory-1-5.png'
                },
                {
                    name: 'Product Name Placeholder A Little Bit Long One',
                    color: 'White',
                    ...
                    price: '$150',
                    deliveryDate: 'Delivered on 9 February 2023',
                    image: 'https://fqjltiegiezfetthbags.supabase.co/storage/v1/render/image/public/block.images/blocks/ecommerce/orderhistory/orderhistory-1-6.png'
                }
            ]
        }
    ];
