    ...
    template: `
        <section class="max-w-6xl mx-auto landing-container relative py-12 lg:py-24">
            <div class="flex lg:flex-row-reverse flex-col items-center gap-14 lg:gap-4 xl:gap-10">
                ...
                <div class="max-w-126 lg:max-w-md mx-auto w-full flex flex-col items-center lg:items-start">
                    <div class="badge mx-0">Financial Management</div>
                    <h4 class="title-h5 md:title-h4 text-center lg:text-left mt-4">Personal Financial Management Tools</h4>
                    <p class="body-small md:body-medium text-center lg:text-left mt-6">Balance your budget, save, and achieve your financial goals using our personal financial management tools.</p>
                    <ul class="list-disc list-inside body-small lg:body-medium text-center lg:text-left mt-8 space-y-3.5">
                        <li>Invest with instant transaction speed.</li>
                        <li>User-friendly investment execution.</li>
                        <li>Advanced investment security.</li>
                    </ul>
